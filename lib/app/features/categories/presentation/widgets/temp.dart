...
class EsnadMenuButtonWidgetTemp extends StatelessWidget {
  const EsnadMenuButtonWidgetTemp({
    super.key,
    ...
    return SizedBox(
      ...
      child: InkWell(
        onTap: () {
              ...
              context, formKey, updatecategoryNameController, entity.id!);
              },
        child: Container(
      ...
      child: InkWell(
        onTap: () {
                ...
                buildGeneralShowDeleteBottomSheet(
                  context,
                  () {
                    context.read<CategoryCubit>().deleteCategory(entity.id!);
                  },
                  "حذف التصنيف",
